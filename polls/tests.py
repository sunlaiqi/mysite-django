...
class QuestionIndexDetailTest(TestCase):
    def test_detail_view_with_a_future_question(self):
        """
        The dtail view of a question with a pub_date in the future should
...
class QuestionViewTest(TestCase):
    def test_index_view_with_no_question(self):
        """
        If now questions exist, an appropriate message should be displayed.
        """
    ...
    def test_index_view_with_a_future_question(self):
        """
        Questions with a pub_date in the future should not e displayed on
        the index page.
        :return:
        """
